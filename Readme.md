...
(i) generating **synthetic specular highlights** using physically based rendering and controlled lighting (including ring-light, inspection-style configurations) and

(ii) training and evaluating **highlight removal** models on paired synthetic data.
